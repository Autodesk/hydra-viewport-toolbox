...
HVT_API extern std::filesystem::path GetGizmoPath(std::string const& gizmoFile);

/// Returns the shader file path.
HVT_API extern std::filesystem::path GetShaderPath(std::string const& shaderFile);
