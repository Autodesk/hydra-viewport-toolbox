...
AGP_TEST(howTo, DISABLED_useWireFrameCollectionRepr)
#else
AGP_TEST(howTo, useWireFrameCollectionRepr)
#endif
{
...
//
#if defined(__ANDROID__) || defined(__APPLE__)
AGP_TEST(howTo, DISABLED_useWireFrameSceneIndex)
#else
AGP_TEST(howTo, useWireFrameSceneIndex)
#endif
{
