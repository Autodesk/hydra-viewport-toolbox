...
AGP_TEST(howTo, DISABLED_useCollectionToExclude)
#else
AGP_TEST(howTo, useCollectionToExclude)
#endif
{
...
// Need to investigate if Android has similar issue too
#if defined(__ANDROID__) || (TARGET_OS_IPHONE == 1)
AGP_TEST(howTo, DISABLED_useCollectionToInclude)
#else
AGP_TEST(howTo, useCollectionToInclude)
#endif
{
    // Helper to create the Hgi implementation.
