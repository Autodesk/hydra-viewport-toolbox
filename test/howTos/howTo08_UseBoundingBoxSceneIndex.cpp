...
AGP_TEST(howTo, DISABLED_useBoundingBoxSceneIndexFilter)
#else
AGP_TEST(howTo, useBoundingBoxSceneIndexFilter)
#endif
{
...

    {
        ...
        // Step 2 - Creates the scene index with the 'BoundingBox' scene index filtering.
