...
AGP_TEST(TestViewportToolbox, DISABLED_TestSearchPrims)
#else
AGP_TEST(TestViewportToolbox, TestSearchPrims)
#endif
{
...
#if TARGET_OS_IPHONE == 1
AGP_TEST_DEFAULT_BACKEND(TestViewportToolbox, DISABLED_TestSearchFaces)
#else
AGP_TEST_DEFAULT_BACKEND(TestViewportToolbox, TestSearchFaces)
#endif
{
...
AGP_TEST_DEFAULT_BACKEND(TestViewportToolbox, DISABLED_TestSearchEdges)
#else
AGP_TEST_DEFAULT_BACKEND(TestViewportToolbox, TestSearchEdges)
#endif
{
...
//
#if defined(__ANDROID__) || TARGET_OS_IPHONE == 1
AGP_TEST(TestViewportToolbox, DISABLED_TestSearchPoints)
#else
AGP_TEST(TestViewportToolbox, TestSearchPoints)
#endif
{
...
AGP_TEST(TestViewportToolbox, TestSearchUsingCube)
{
