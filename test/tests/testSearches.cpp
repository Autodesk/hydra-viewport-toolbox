...
#endif
{
    ...
    static const std::vector<VtIntArray> results
        ...
        = isSoftwareRendering ?
            // Software rendering results (Linux CI)
            std::vector<VtIntArray>{ { 102, 105, 108, 109, 110, 111, 112, 113, 114, 117, 615, 618, 619, 620, 621, 624, 627,
                628, 630, 633, 636, 637, 639, 642, 645, 646, 648, 651, 654, 655, 657, 660, 666, 768,
                769, 770, 771, 774, 777, 778, 780, 783, 786, 787, 789, 792, 795, 796, 798, 799, 801,
                804, 807, 808, 810 } } :
            // Windows and Linux hardware results (shared)
            std::vector<VtIntArray>{ { 0, 3, 21, 60, 69, 75, 84, 93, 102, 105, 108, 109, 110, 111, 112, 113, 114, 117, 123,
...
#endif
{
    ...
    static const std::vector<VtIntArray> results
        ...
        = isSoftwareRendering ? 
            // Software rendering results (Linux CI)
            std::vector<VtIntArray>{ { 217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 228, 229, 230, 231, 232, 233,
