...
AGP_TEST(TestViewportToolbox, framePassUID)
{
...
AGP_TEST(TestViewportToolbox, DISABLED_testFramePassColorSpace)
#else
AGP_TEST(TestViewportToolbox, testFramePassColorSpace)
#endif
{
...
AGP_TEST_DEFAULT_BACKEND(TestViewportToolbox, DISABLED_testDynamicCameraAndLights)
#else
AGP_TEST_DEFAULT_BACKEND(TestViewportToolbox, testDynamicCameraAndLights)
#endif
{
...
#if defined(__ANDROID__) || TARGET_OS_IPHONE == 1
AGP_TEST(TestViewportToolbox, DISABLED_testDynamicResolution)
#else
AGP_TEST(TestViewportToolbox, testDynamicResolution)
#endif
{
