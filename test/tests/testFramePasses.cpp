...
AGP_TEST(TestViewportToolbox, TestFramePasses_MainOnly)
{
...
AGP_TEST_DEFAULT_BACKEND(TestViewportToolbox, DISABLED_TestFramePasses_MainWithBlur)
#else
AGP_TEST_DEFAULT_BACKEND(TestViewportToolbox, TestFramePasses_MainWithBlur)
#endif
{
    auto context = TestHelpers::CreateTestContext();
...
// Note: As Android is now built on macOS platform, the same challenge exists!
#if defined(__APPLE__) || defined(__ANDROID__)
AGP_TEST(TestViewportToolbox, DISABLED_TestFramePasses_MainWithFxaa)
#else
AGP_TEST(TestViewportToolbox, TestFramePasses_MainWithFxaa)
#endif
{
    auto context = TestHelpers::CreateTestContext();
...
//
AGP_TEST(TestViewportToolbox, TestFramePasses_SceneIndex)
{
    auto context = TestHelpers::CreateTestContext();
