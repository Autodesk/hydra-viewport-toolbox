...
bool RenderBufferManagerSIImpl::IsAovSupported() const
{
    return _pRenderIndex->IsBprimTypeSupported(HdPrimTypeTokens->renderBuffer);
}

GfVec2i const& RenderBufferManagerSIImpl::GetRenderBufferSize() const
{
    return _renderBufferSize;
}

void RenderBufferManagerSIImpl::_PrepareBuffersFromInputs(RenderBufferBinding const& colorInputAov,
...
void RenderBufferManagerSIImpl::_PrepareDepthOnlyFromInput(
    RenderBufferBinding const& inputDepthAov, HdRenderBufferDescriptor const& desc,
    SdfPath const& controllerId)
{
    HD_TRACE_FUNCTION();
    HF_MALLOC_TAG_FUNCTION();
...
bool RenderBufferManagerSIImpl::SetRenderOutputs(TfToken const& outputToVisualize,
...
void RenderBufferManagerSIImpl::SetViewportRenderOutput(
...
HdRenderBuffer* RenderBufferManagerSIImpl::GetRenderOutput(
...
void RenderBufferManagerSIImpl::SetRenderOutputClearColor(
...
void RenderBufferManagerSIImpl::SetBufferSizeAndMsaa(
